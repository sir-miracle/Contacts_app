...
class PhoneContacts : AppCompatActivity() {
    ...
    private fun requestPermissions(): Boolean{
        ...
        if (permissionsToRequest.isNotEmpty()){
            if(ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_CONTACTS)){
                AlertDialog.Builder(this).setTitle("Permission needed").setMessage("For the app to read your contacts, you have to give the permission to do so")
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    fun readContacts(){
        var cursor : Cursor? = contentResolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, null, null)
        ...
        var listAdapter = SimpleCursorAdapter(this,android.R.layout.simple_list_item_2,cursor,from,to)
